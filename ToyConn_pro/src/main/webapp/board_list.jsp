                ...
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li style="margin: 30px;">
                                <a href="trade_list.html" style="font-size: large;font-weight: 600;">장난감 등록</a>
                                <ul class="sub-menu">
                            ...
                            <li style="margin: 30px;">
                                <a href="board_list.html" style="font-size: large;font-weight: 600;">게시판</a>
                            </li>

                            <li>
                                <a href="toy_join.html" style="font-size: large;font-weight: 600;">거래 목록</a>
                            </li>
                        </ul>
                    </div>
