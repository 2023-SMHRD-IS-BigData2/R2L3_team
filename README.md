...
<br>
 <ul>
   ...
   <li>하지만 실시간 채팅을 하기 위해서는 웹 소켓 방법이 필요했고 찾아본 결과 Socket.io<a href="https://velog.io/@moonshadow/Socket.IO%EB%A5%BC-%EC%95%8C%EC%95%84%EB%B3%B4%EC%9E%90">(소켓아이오로 채팅창 만들기)</a>와 Spring 프레임 워크에서 지원하는 웹소켓<a href="https://velog.io/@sunkyuj/Spring-%EC%9B%B9%EC%86%8C%EC%BC%93%EC%9C%BC%EB%A1%9C-%EC%8B%A4%EC%8B%9C%EA%B0%84-%EC%B1%84%ED%8C%85-%EA%B5%AC%ED%98%84">(웹소켓으로 채팅창만들기)</a>을 활용하는 방법이 었습니다</li>
