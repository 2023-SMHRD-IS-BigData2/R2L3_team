...
<br>
 <ul>
   ...
   <li>하지만 실시간 채팅을 하기 위해서는 웹 소켓 방법이 필요했고 찾아본 결과 Socket.io<a href="https://velog.io/@moonshadow/Socket.IO%EB%A5%BC-%EC%95%8C%EC%95%84%EB%B3%B4%EC%9E%90">소켓아이오로 채팅창 만들기</a>와 Spring 프레임 워크에서 지원하는 웹소켓을 활용하는 방법이 었습니다</li>
